...
type Ruler interface {
	...
	AddAlertingRule(ruleNamespace *corev1.Namespace, extraRuleResourceSelector labels.Selector,
		group string, rule *promresourcesv1.Rule, ruleResourceLabels map[string]string) error
	UpdateAlertingRule(ruleNamespace *corev1.Namespace, extraRuleResourceSelector labels.Selector,
		group string, rule *promresourcesv1.Rule, ruleResourceLabels map[string]string) error
	DeleteAlertingRule(ruleNamespace *corev1.Namespace, extraRuleResourceSelector labels.Selector,
...
func (r *PrometheusRuler) AddAlertingRule(ruleNamespace *corev1.Namespace, extraRuleResourceSelector labels.Selector,
	group string, rule *promresourcesv1.Rule, ruleResourceLabels map[string]string) error {
	return errors.New("not supported to add rules for prometheus")
}

func (r *PrometheusRuler) UpdateAlertingRule(ruleNamespace *corev1.Namespace, extraRuleResourceSelector labels.Selector,
	group string, rule *promresourcesv1.Rule, ruleResourceLabels map[string]string) error {
	return errors.New("not supported to update rules for prometheus")
}

func (r *PrometheusRuler) DeleteAlertingRule(ruleNamespace *corev1.Namespace, extraRuleResourceSelector labels.Selector,
	group string, name string) error {
	return errors.New("not supported to update rules for prometheus")
}
...
func (r *ThanosRuler) AddAlertingRule(ruleNamespace *corev1.Namespace, extraRuleResourceSelector labels.Selector,
	group string, rule *promresourcesv1.Rule, ruleResourceLabels map[string]string) error {
	...
	return r.addAlertingRule(ruleNamespace, prometheusRules, nil, group, rule, ruleResourceLabels)
}

func (r *ThanosRuler) addAlertingRule(ruleNamespace *corev1.Namespace,
...
func (r *ThanosRuler) UpdateAlertingRule(ruleNamespace *corev1.Namespace, extraRuleResourceSelector labels.Selector,
	group string, rule *promresourcesv1.Rule, ruleResourceLabels map[string]string) error {
	...
	if !success {
		err := r.addAlertingRule(ruleNamespace, prometheusRules, resourcesToDelRule, group, rule, ruleResourceLabels)
		if err != nil {
			return err
		}
	}
...
func (r *ThanosRuler) DeleteAlertingRule(ruleNamespace *corev1.Namespace, extraRuleResourceSelector labels.Selector,
	group string, name string) error {
	prometheusRules, err := r.ListRuleResources(ruleNamespace, extraRuleResourceSelector)
	if err != nil {
		return err
