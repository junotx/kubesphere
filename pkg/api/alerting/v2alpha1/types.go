...
type BulkItemResponse struct {
	...
	Status    Status    `json:"status,omitempty" description:"It can be success or error"`
	Result    Result    `json:"result,omitempty" description:"It is only returned for successful operations"`
	ErrorType ErrorType `json:"errorType,omitempty" description:"It is only returned for failed operations"`
	Error     error     `json:"-"`
